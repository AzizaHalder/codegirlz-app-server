...
const meetupSchema = new Schema(
    {
        ...
        // required
        eventType: { type: String, enum: ["Digital", "In-Person"], required: [true, "Event type is required."] },
        ...
        eventDescription: { type: String, required: [true, "Event Description is required. Please tell more about your event!"] },
